...
def plan_evaluation(agent, plan_list):
    try:
        ...
        best_plan = select_plan(agent.tracer, plan_list, p_context,basic_needs,agent.short_memory.recent_events) 
...
def select_plan(tracer, plan_list, p_context, basic_needs, recent_events):
    ...
    plan = plans_selection(tracer, plan_list, p_context, recent_events, basic_needs, biases)
    return plan
